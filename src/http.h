...
/* POST one JSON body with optional headers and a cancellable transfer. */
int
http_post_json(const char *, const char *, const char *, const char *,
    const char *, http_cancel_callback, void *, struct http_response *, char *,
    size_t);
/* POST JSON while bounding the complete transfer in milliseconds. */
int
http_post_json_timeout(const char *, const char *, const char *, const char *,
    const char *, int, http_cancel_callback, void *, struct http_response *,
    char *, size_t);
...
/* POST an OAuth form while bounding the complete transfer in milliseconds. */
int
http_post_form_timeout(const char *, const char *, int, http_cancel_callback,
    void *, struct http_response *, char *, size_t);
